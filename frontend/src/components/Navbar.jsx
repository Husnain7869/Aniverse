    ...
    <>
      <header style={{
        ...
        <div onClick={() => navigate("/")} style={{ display:"flex", alignItems:"center", gap:8, cursor:"pointer", marginRight:28, flexShrink:0 }}>
          ...
          <span style={{ fontSize:19, fontWeight:800, color:"#1e1b4b", fontFamily:"'Playfair Display',serif", letterSpacing:"-0.3px" }}>Shiori</span>
        </div>
          ...
          <div className="mobile-nav-panel" onClick={e => e.stopPropagation()}>
            ...
            <div style={{ display:"flex", alignItems:"center", justifyContent:"space-between", marginBottom:20 }}>
              <div style={{ display:"flex", alignItems:"center", gap:8 }}>
                ...
                <span style={{ fontSize:17, fontWeight:800, color:"#1e1b4b" }}>Shiori</span>
              </div>
